...
end_date = '2020-12-06'
#拼接fenshi1和fenshi2
#拼接后的数据保存到fenshi1所在的目录下
fenshi1_path = 'E:/Stock/version2.0/dataDownload/20200101_20201001/fenshi/fenshi_20200101_20201001.csv'
fenshi2_path =  'E:/Stock/version2.0/dataDownload/20201001_20201101/fenshi/fenshi_20201001_20201101.csv'
fq_path = 'F:/Smart实验室/量化投资/dataDownload/20200101_20201101/fq_factor_0101_1101.csv'
...
print('写最终文件')
fenshi_final.to_csv(fenshi1_path + 'fenshi_after_fq_0101_1101_v2.csv',index=False)
